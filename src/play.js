...
function render() {
  ...
  $('waitView').hidden = ['answer', 'fire', 'charge'].includes(view);
...
function renderWait(view) {
  ...
  switch (view) {
    ...
    case 'unleash':
      ...
      text = 'Bình nước của cả hội trường đang bay về phía Quái Vật. Nhìn lên màn hình lớn — đòn kết liễu bắt đầu rồi!';
      break;
    case 'victory':
      badge = { kind: 'good', content: '🦊' };
